module.exports = {
    remainingDays(job) {
      ...
      const dayDiff = Math.ceil(timeDiffInMs / dayInMs); // Math.floor vai arredondar o número de dias para baixo. o Math.ceil arredonda para cima. Math.floor(14.7) = 14 / Math.ceil(14.6) = 15
